...
class Command(BaseCommand):
    help = "Crea grupos Grupo e Individual y asigna permisos base"
    ...
    def handle(self, *args, **options):
        ...
        can_add_elemento = Permission.objects.get(
            codename='add_elemento', content_type=ct_elemento
        )
        can_add_stock = Permission.objects.get(
            codename='add_stock', content_type=ct_stock
        )
